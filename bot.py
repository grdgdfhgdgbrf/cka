...
def auto_install_all():
    """Автоматическая установка всех зависимостей для Windows"""
    log_message("=" * 50)
...
def get_ffprobe_path():
    """Получение пути к ffprobe.exe"""
    ffprobe_path = os.path.join(os.getcwd(), TOOLS_DIR, "ffmpeg", "bin", "ffprobe.exe")
